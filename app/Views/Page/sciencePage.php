...
<body>
    ...
    <div class="main">
        <div class="menu">
            ...
            <span class="haiyu">Smart Brain</span>
        </div>
    </div>
    <main>
        <div class="Isi">
            ...
            <div class="row">
                <div class="col-6 col-md-4 column">
                    <div class="cardMath">
                        ...
                        <h3 id="titleSub">Teknologi</h3>
                    </div>
                </div>
                <div class="col-6 col-md-4 column">
                    <div class="titlePage">
                        <h1 id="title">SUBJECT<br>
                        </h1>
                    </div>
                </div>
                <div class="col-6 col-md-4 column">
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-4 column">
                    <div class="cardBiology">
                        <img src="../images/edu/003-university.png" alt="Biologi" id="icon" onclick="location.href = '/science/biology'">
                        <h3 id="titleSub">Sejarah</h3>
                    </div>
                </div>
            </div>
        </div>
